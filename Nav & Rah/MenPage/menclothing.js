...
<div id="menscloths">
  ...
  <li id="list" >Mother's Day Gifts</li>
  <li id="list" >New Arrivals</li>
   <li > Best Sellers</li>
   <li > Designer Brands</li>
   <li >Contemporary Brands</li>
   <li >Graphic Tees Under $25</li>
  <li > Denim Under $50</li>
  <li >Swim & Sun Under $50</li>
  <li >Sneakers Under $50</li>
  <li >Wedding Shop</li>
  ...
  <li>Lingerie, Hosiery & Shapewear</li>
  <li>Loungewear</li>
  ...
  <li>Oxfords & Derbys</li>
  <li>Sandals & Flip-Flops</li>
  <li>Slippers</li>
  <li>Sneakers</li>
  <li>Extended Shoe Sizes & Widths</li>
